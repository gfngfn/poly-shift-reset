polysr.exe: typevar.mli typevar.ml range.mli range.ml types.ml lexer.mll parser.mly typeenv.mli typeenv.ml subst.mli subst.ml typecheck.mli typecheck.ml rename.mli rename.ml evalenv.ml evaluator.ml primitives.ml main.ml
	ocamllex lexer.mll
